...
const VideoPlayer = () => {
  return (
   ...
   <div className="text-white">
     ...
     <h1 className="mt-4 lg:mt-0 text-5xl lg:text-6xl font-semibold " style={{ textShadow: '2px 2px 4px #fff' }}>150+</h1>
     <span className="text-2xl" style={{ textShadow: '2px 2px 4px #fff' }}>Universities Participating</span>

     <div className="mt-6 flex gap-8">
       <div>
         <h1 className="text-3xl lg:text-5xl">72+</h1>
         <span className="text-lg lg:text-2xl">Judges</span>
       </div>
       <div>
         <h1 className="text-3xl lg:text-5xl">21</h1>
         <span className="text-lg lg:text-2xl">Hackathons</span>
       </div>
       <div>
         <h1 className="text-3xl lg:text-5xl">36+</h1>
         <span className="text-lg lg:text-2xl">Great Speakers</span>
       </div>
     </div>
