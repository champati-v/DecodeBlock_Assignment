...
return (
<> 
    <div className="fixed z-50 h-16 flex items-center justify-between px-5 lg:px-20 w-full bg-black">
    ...
    <AnimatePresence>
        <motion.div 
            ...
            className="fixed inset-0 top-[60px] flex flex-col gap-3 items-center justify-center bg-gradient-to-br from-[#100f13] via-[#150f19] to-[#352436] h-[calc(100vh-60px)] w-full z-50"
        >
